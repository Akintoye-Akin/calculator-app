...
import {default as NumberFormat} from "react";
  ...
  return (
    <div className='container'>
      <div className='wrapper'>
        ...
        <div className='btn coral' onClick={reset}>
          AC
        </div>
        <div className='btn coral' onClick={percent}>
          %
        </div>
        <div className='btn coral' onClick={minusPlus}>
          +/-
        </div>
